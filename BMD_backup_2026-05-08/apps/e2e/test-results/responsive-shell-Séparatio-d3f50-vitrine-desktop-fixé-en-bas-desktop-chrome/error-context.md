...
- Name: responsive-shell.spec.ts >> Séparation Mobile / Desktop >> FX ticker présent sur la vitrine desktop, fixé en bas
- Location: tests/responsive-shell.spec.ts:42:3
...
Locator: getByRole('complementary', { name: /taux de change/i })
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('complementary', { name: /taux de change/i })
