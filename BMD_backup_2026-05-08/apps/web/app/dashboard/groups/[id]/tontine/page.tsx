...
export default function TontinePage() {
  ...
  return (
    <ResponsiveShell
      ...
      primaryAction={tontineStatusBadge}
      mobileTitle="Tontine"
      back={{ href: `/dashboard/groups/${groupId}` }}
    ...
    >
      ...
      {!tontine && showCreate && (
        <div className="card">
          ...
          <div className="field">
            <label>{t("tontine.contributionPerMember", { currency: group.defaultCurrency })}</label>
            <input
          ...
          <div className="field">
            <label>{t("tontine.startDate")}</label>
            <input
              type="date"
              value={startDate}
          ...
          <div className="field">
            <label>{t("tontine.orderMode")}</label>
            <div
              style={{
                display: "grid",
            ...
            >
              {[
                ...
                { v: "AUCTION", lbl: "🪙 " + t("tontine.auctionLabel") },
              ].map((opt) => (
                <button
                  key={opt.v}
                  type="button"
          ...
          {orderMode === "AUCTION" && (
            ...
            >
              🪙 <strong>{t("tontine.modeHuiAuctions")}</strong> — pour chaque tour, les
              membres misent ce qu'ils acceptent de céder aux autres pour gagner
              le pot. La plus haute mise gagne. C'est le système traditionnel
              asiatique 標會, idéal pour les tontines où chacun a des besoins
              ponctuels variables.
            </div>
          )}
