      ...
      <div className="card">
        ...
        >
          <li style={{ marginBottom: 8 }}>
            ✓ <strong>{t("legal.privacy.identity")}</strong> : ton nom affiché (que tu choisis),
          ...
          <li style={{ marginBottom: 8 }}>
            ✓ <strong>{t("legal.privacy.bmdActivity")}</strong> : groupes auxquels tu
      ...
      <div className="card">
        ...
        >
          ...
          <li>
            ...
            ses données par email à <strong>privacy@backmesdo.com</strong>. On le
            fait sous 30 jours.
          </li>
        </ul>
      </div>
