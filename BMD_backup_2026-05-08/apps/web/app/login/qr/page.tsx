        ...
        {status === "waiting" && token && (
          <>
            ...
            >
              ...
              >
                {/* QR avec couleurs BMD : foreground saffron/indigo, background cream */}
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=240x240&ecc=H&color=2A2244&bgcolor=F4E4C1&qzone=1&data=${encodeURIComponent(qrUrl)}`}
                  alt={t("auth.qrAlt")}
                  width={216}
                  height={216}
                  style={{ display: "block", margin: "0 auto" }}
                />
                {/* Logo BMD centré — superposé en absolu. Le ECC=H permet de
                    masquer ~30% du QR sans casser le scan. */}
                <div
                  aria-hidden
                  style={{
                    position: "absolute",
                    ...
                    boxShadow:
                      "0 4px 12px rgba(0,0,0,0.4), 0 0 0 4px #F4E4C1",
                  }}
                >
                  <span
                    style={{
                  ...
                  >
                    B<span style={{ color: "#F4E4C1" }}>·</span>M
                    <span style={{ color: "#F4E4C1" }}>·</span>D
                  </span>
                </div>
              </div>
            </div>
