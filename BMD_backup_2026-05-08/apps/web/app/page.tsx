  ...
  return (
    <>
      ...
      <div className="bmd-mkt" dir={rtl ? "rtl" : "ltr"}>
        ...
        >
          <BrowserFrame url="www.backmesdo.com/login">
            ...
            >
              {t.features.items.map((f, i) => (
                ...
                >
                  ...
                  <p style={{ fontSize: 13, color: "var(--cream-soft)", lineHeight: 1.6 }}>
                    {f.body}
                  </p>
                </div>
              ))}
          ...
          >
            {t.howItWorks.steps.map((s, i) => (
              <div key={i}>
                ...
                <h3 style={{ fontSize: 20, color: "var(--cream)", marginBottom: 8 }}>
                  {s.title}
                </h3>
                <p style={{ fontSize: 14, color: "var(--cream-soft)", lineHeight: 1.6 }}>
                  {s.body}
                </p>
              </div>
            ))}
        ...
        >
          ...
          >
            ...
            <p style={{ color: "var(--cream-soft)", marginBottom: 28, fontSize: 16 }}>
              {t.cta.body}
            </p>
            <Link
              href="/login"
    ...
    <div>
      ...
      <div className="bmd-sidebar-layout">
              ...
              <button
                ...
                style={{
                  ...
                  background: isActive
                    ...
                    : "transparent",
                  color: isActive ? "var(--night-2)" : "var(--cream)",
                  border: isActive
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(42,34,68,0.35), rgba(22,17,30,0.6))",
            border: "1px solid var(--line-soft)",
            borderRadius: 16,
            padding: "18px 20px",
            minHeight: 320,
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: 12,
                    background:
                      "linear-gradient(135deg, rgba(232,163,61,0.22), rgba(181,70,46,0.14))",
                    border: "1px solid var(--line)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                  ...
                  >
                    ...
                    >
                      {it.icon && (
                        <span
                          aria-hidden="true"
                          style={{ fontSize: 15, color: "var(--saffron)" }}
                        >
                          {it.icon}
                        </span>
                      )}
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 18,
        background:
          "radial-gradient(700px 400px at 80% 0%, rgba(232,163,61,0.15), transparent 60%), linear-gradient(180deg, rgba(42,34,68,0.5), rgba(22,17,30,0.85))",
        border: "1px solid var(--line)",
      }}
    >
      <p
      ...
      >
        <Link
          ...
          style={{
            ...
            minHeight: 40,
            letterSpacing: 0.3,
            boxShadow: "0 8px 22px rgba(232,163,61,0.22)",
            flexShrink: 0,
          }}
        >
          {data.cta.label} →
        ...
        >
          {activeCat && (
            <>
              ...
              >
                💬 {renderContactNudge(data.contactNudge, supportEmail)}
              </div>
            </>
          )}
        </div>
...
function StorySection({
  ...
  return (
    <div>
      ...
      >
        {data.chapters.map((c, i) => (
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(42,34,68,0.5), rgba(22,17,30,0.7))",
              border: "1px solid rgba(232,163,61,0.18)",
              borderRadius: 16,
              padding: "22px 20px",
              display: "flex",
          ...
          >
            <div
              style={{
                ...
                borderRadius: 14,
                background:
                  "linear-gradient(135deg, rgba(232,163,61,0.22), rgba(181,70,46,0.16))",
                border: "1px solid var(--line)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
      ...
      {/* Manifesto + CTA — bandeau gold subtle */}
      <div
        style={{
          display: "flex",
          alignItems: "center",
          ...
          borderRadius: 18,
          background:
            "radial-gradient(700px 280px at 30% 50%, rgba(232,163,61,0.18), transparent 60%), linear-gradient(180deg, rgba(42,34,68,0.6), rgba(22,17,30,0.85))",
      ...
      >
        ...
        <Link
          ...
          style={{
            ...
            alignItems: "center",
            letterSpacing: 0.3,
            boxShadow: "0 10px 26px rgba(232,163,61,0.25)",
            flexShrink: 0,
          }}
        >
          {data.cta} →
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ fontSize: 11, color: "var(--cream-soft)", opacity: 0.6 }}>
            Bonsoir,
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              + 247,50
              <span style={{ color: "var(--saffron)", fontSize: 20 }}>€</span>
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              <span style={{ color: "var(--emerald-soft)", fontWeight: 600 }}>
                ↗ On vous doit 412 €
              </span>
          ...
          >
            {[
              ...
              >
                <span style={{ fontSize: 16, color: "var(--saffron)" }}>{q.ic}</span>
                {q.lbl}
              </div>
            ))}
          </div>
          ...
          {[
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 9, color: "var(--muted)" }}>{g.m}</div>
              </div>
              <div
                style={{
                  fontSize: 11,
...
function FloatTag({
  ...
  return (
    ...
    >
      ...
      `}</style>
      <span style={{ fontSize: 14, color: "var(--saffron)" }}>{icon}</span>
      <span>
        <strong style={{ display: "block", color: "var(--cream)" }}>{title}</strong>
        <span style={{ color: "var(--cream-soft)" }}>{subtitle}</span>
      </span>
    </div>
  );
}
