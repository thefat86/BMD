      ...
      {items.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {items.map((it, idx) => (
            ...
            >
              {/* Ligne principale : description + quantité + prix + supprimer */}
              <div
                style={{
                  display: "grid",
              ...
              {/* Ligne assignation : qui consomme cet article ? */}
              {members && members.length > 0 && (
                <ItemMembersAssign
                  members={members}
                  selected={it.assignedUserIds ?? []}
                  onChange={(ids) =>
                    update(idx, { assignedUserIds: ids })
                  }
                />
              )}
            </div>
  ...
  return (
    <div
      style={{
        ...
        alignItems: "center",
        paddingTop: 4,
        borderTop: "1px dashed rgba(244,228,193,0.08)",
      }}
    >
      <span
        style={{
      ...
      <button
        type="button"
        onClick={() => onChange([])}
        title={t("expense.allShareItemNote")}
        style={{
          padding: "2px 8px",
          fontSize: 10,
          fontWeight: 600,
          background:
            selected.length === 0
              ...
              : "transparent",
          color:
            selected.length === 0 ? "#16111e" : "var(--cream-soft, #d4c4a8)",
          border:
            selected.length === 0
              ? "1px solid var(--saffron, #E8A33D)"
              : "1px solid var(--line-soft, rgba(244,228,193,0.15))",
          borderRadius: 999,
          cursor: "pointer",
          minHeight: 24,
        }}
        ...
        return (
          <button
            ...
            style={{
              ...
              fontSize: 10,
              fontWeight: 600,
              background: active ? "var(--saffron, #E8A33D)" : "transparent",
