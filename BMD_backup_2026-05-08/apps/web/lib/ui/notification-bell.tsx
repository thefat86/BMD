...
export function NotificationBell(): JSX.Element | null {
  ...
  // SSE temps réel : dès qu'une nouvelle notif est créée côté serveur,
  // on incrémente le badge instantanément + on reload la liste si elle
  // est ouverte. Pas besoin d'attendre le prochain tick polling.
  useMyEvents((event) => {
