/**
 * Validateurs locaux pour l'API (E.164 / RFC 5322 simplifié).
 *
 * Pourquoi pas dans @bmd/shared-types ? Node v24 en mode ESM strict refuse
 * de charger les fonctions exportées par un package CJS sans "type": "module".
 * On duplique côté web/lib/validators.ts (sync manuelle) plutôt que de
 * casser l'interop existante.
 */
