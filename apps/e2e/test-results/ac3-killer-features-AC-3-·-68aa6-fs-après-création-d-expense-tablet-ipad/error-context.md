...
- Name: ac3-killer-features.spec.ts >> AC-3 · Audio proof bouton >> Bouton 🎙️ Audio est rendu dans la zone justificatifs après création d'expense
- Location: tests/ac3-killer-features.spec.ts:67:3
  ...
  - generic [ref=e237] [cursor=pointer]:
    ...
    - generic [ref=e244]:
      ...
      - button "Collapse issues badge" [ref=e250]:
        - img [ref=e251]
  - alert [ref=e253]
  - generic "Build dev — tape 🧹 pour clear tout" [ref=e254]:
    - generic [ref=e255]: DEV · 13:29:21
    - button "Force fresh (clear all caches and reload)" [ref=e256] [cursor=pointer]: 🧹
```
