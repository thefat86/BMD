...
- Name: booster-purchase.spec.ts >> Flow achat Pack IA Booster (mode mock dev) >> BoosterPurchaseCard s'affiche sur /dashboard/plans pour un user FREE
- Location: tests/booster-purchase.spec.ts:53:3
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e15]:
      ...
      - paragraph [ref=e18]:
        - text: Code envoyé à
        - strong [ref=e19]: booster-render-mp5ehnn0-gtve@bmd-e2e.local
      - generic [ref=e20]:
        - generic [ref=e21]:
          - text: Code à 6 chiffres
          - button "Code à 6 chiffres" [ref=e22] [cursor=pointer]: 🙈 Masquer
        - textbox "123456" [ref=e23]: "594444"
      - generic [ref=e24]:
