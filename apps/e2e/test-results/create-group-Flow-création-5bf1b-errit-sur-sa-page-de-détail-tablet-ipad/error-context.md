...
- Name: create-group.spec.ts >> Flow création de groupe >> Crée un groupe TONTINE et atterrit sur sa page de détail
- Location: tests/create-group.spec.ts:18:3
