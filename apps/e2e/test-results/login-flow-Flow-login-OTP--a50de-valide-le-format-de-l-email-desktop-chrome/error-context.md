...
- generic [ref=e1]:
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e15]:
      ...
      - generic [ref=e17]:
        - generic [ref=e18]: Méthode
        - combobox [ref=e19]:
          - option "📞 Téléphone"
          - option "✉️ Email" [selected]
      - generic [ref=e20]:
        - generic [ref=e21]: Adresse email
        - textbox "ton.email@exemple.com" [active] [ref=e22]: pas-un-email
      - generic [ref=e23]: "⚠ Format email invalide (ex: nom@exemple.com)"
      - button "Recevoir un code" [disabled] [ref=e24]
      - paragraph [ref=e25]: En mode dev, le code s'affiche dans la console du backend.
      - generic [ref=e26]: ou
      - link "⊞ Scanner le QR depuis l'app mobile" [ref=e29] [cursor=pointer]:
        - /url: /login/qr
      - button "Se connecter avec Windows Hello" [ref=e30] [cursor=pointer]:
        - img [ref=e31]
        - generic [ref=e34]: Clé de sécurité
  - region "Notifications"
  - button "Open Next.js Dev Tools" [ref=e40] [cursor=pointer]:
    - img [ref=e41]
  - alert [ref=e44]
  - generic "Build dev — tape 🧹 pour clear tout" [ref=e45]:
    - generic [ref=e46]: DEV · 13:25:08
    - button "Force fresh (clear all caches and reload)" [ref=e47] [cursor=pointer]: 🧹
```
