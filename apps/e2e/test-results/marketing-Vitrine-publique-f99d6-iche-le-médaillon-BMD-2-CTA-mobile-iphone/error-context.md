...
- Name: marketing.spec.ts >> Vitrine publique >> Mobile : la home affiche le médaillon BMD + 2 CTA
- Location: tests/marketing.spec.ts:35:3
...
Locator: getByRole('link', { name: /se connecter|login|sign in/i }).first()
Expected: visible
Timeout: 10000ms
