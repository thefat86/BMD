...
- Name: profile.spec.ts >> Page profil >> PasskeyManager : section accessible via tile sécurité
- Location: tests/profile.spec.ts:92:3
...
Locator: getByRole('heading', { name: /passkeys/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /passkeys/i }).first()
...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e196]
  - generic [ref=e198]:
    - link "Retour au tableau de bord" [ref=e199]:
      - /url: /dashboard
      - img [ref=e200]
    - button "Changer la photo de profil" [ref=e202] [cursor=pointer]:
      - generic [ref=e204]: E
      - img [ref=e206]
    - generic [ref=e209]:
      - generic [ref=e210]: E2E Tester
      - generic [ref=e211]: EUR · FR
    - link "FREE" [ref=e212]:
      - /url: /dashboard/plans
    ...
    - generic [ref=e214]:
      - generic [ref=e215]:
        - generic [ref=e216]: "0"
        - generic [ref=e217]: Groupes
      - generic [ref=e218]:
        - generic [ref=e219]: "0"
        - generic [ref=e220]: Tontines
      - generic [ref=e221]:
        - generic [ref=e222]: "0"
        - generic [ref=e223]: Dépenses
  - generic "Build dev — tape 🧹 pour clear tout" [ref=e224]:
    - generic [ref=e225]: DEV · 13:28:08
    - button "Force fresh (clear all caches and reload)" [ref=e226] [cursor=pointer]: 🧹
```
