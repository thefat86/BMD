...
- Name: v45-features.spec.ts >> V45 features — smoke tests runtime >> Page /dashboard/plans/success mobile-native rend sans erreur (Stripe confirmation)
- Location: tests/v45-features.spec.ts:224:3
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e15]:
      ...
      - paragraph [ref=e17]:
        - text: Code envoyé à
        - strong [ref=e18]: v52-success-mp5enn0f-mua2@bmd-e2e.local
      - generic [ref=e19]:
        - generic [ref=e20]:
          - text: Code à 6 chiffres
          - button "Code à 6 chiffres" [ref=e21] [cursor=pointer]: 🙈 Masquer
        - textbox "123456" [ref=e22]: "425244"
      - generic [ref=e23]:
