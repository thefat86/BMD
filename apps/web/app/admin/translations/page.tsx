...
export default function TranslationsAdminPage() {
  ...
  // V184.A — Debounce 300ms du champ de recherche pour éviter de spammer le
  // backend à chaque frappe (chaque frappe sinon = 1 requête `adminListTranslations`).
  ...
  // V184.A — Propage `search` vers `debouncedSearch` avec 300ms de latence.
  useEffect(() => {
