    ...
    <div>
      ...
      {isRegionalPricing && regionName && (
        <div
          style={{
            background:
              "linear-gradient(135deg, rgba(197,138,46,0.12), rgba(159,70,40,0.06))",
        ...
        >
          ...
          <strong style={{ color: "#C58A2E" }}>{regionName}</strong>. Le prix
        ...
        return (
          <div
            ...
            style={{
              ...
              border: isFree
                ? `1.5px solid #C58A2E`
                : "1px solid rgba(197,138,46,0.22)",
              borderRadius: 16,
              padding: "20px 18px",
              position: "relative",
              minWidth: 0,
          ...
          >
            ...
            {bullets.length > 0 && (
              ...
              >
                {bullets.map((f, i) => (
                  <li key={i}>
                    <span style={{ color: "#1F7A57", marginRight: 6 }}>✓</span>
                    {f}
                  </li>
                ))}
              </ul>
