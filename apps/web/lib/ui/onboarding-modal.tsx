...
interface Choice {
  ...
  // V52.C3 — SVG remplace EMOJI : on passe d'icon string (emoji) à un IconName
  // typé du registry V45.
  iconName: IconName;
  title: string;
  desc: string;
}
    ...
    return (
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          ...
          >
            {/* V181 — Modal d'onboarding affiché à la demande : loading=lazy + decoding=async. */}
          ...
          {CHOICES.map((c) => (
            ...
            >
              ...
              >
                ...
                <Icon name={c.iconName} size={28} color="currentColor" strokeWidth={1.6} />
              </div>
        ...
        >
          {CHOICES.map((c) => (
            ...
            >
              ...
              >
                <Icon name={c.iconName} size={32} color="currentColor" strokeWidth={1.6} />
              </div>
              <div
                style={{
                  fontSize: 14,
