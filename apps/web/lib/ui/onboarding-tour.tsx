  ...
  return (
    <div
      ...
      style={{
        ...
        display: "flex",
        // V37 — Sur mobile : slide-up depuis le bas. Sur desktop : centré.
    ...
    >
      {/* V106 — Modal onboarding migré en V45-light : fond ivory + cocoa
          au lieu du gradient indigo→night legacy. Les illustrations SVG des
          steps gardent leur palette historique (refondre les SVG demande
          plus de soin — c'est traité plus tard si l'effet sur clair gêne). */}
      <div
        style={{
          background:
            "linear-gradient(140deg, #FBF6EC 0%, #F4ECD8 100%)",
          border: "1px solid rgba(197,138,46,0.30)",
          borderBottom: isMobile ? "none" : "1px solid rgba(197,138,46,0.30)",
          borderRadius: isMobile ? "22px 22px 0 0" : 22,
          padding: isMobile
            ? "10px 22px calc(env(safe-area-inset-bottom, 0px) + 18px)"
            : "24px 22px 18px",
          ...
          boxShadow: "0 24px 60px rgba(43,31,21,0.22)",
          animation: isMobile
            ? "bmd-tour-slideup 0.3s ease-out"
            : "bmd-tour-pop 0.3s ease-out",
        }}
        onClick={(e) => e.stopPropagation()}
      >
        {/* Drag handle visible sur mobile — pattern BottomSheet natif */}
        {isMobile && (
          <div
            aria-hidden
            style={{
        ...
        {/* Illustration — encart V45-saffron-pale pour contraster le SVG
            interne qui garde ses couleurs historiques. */}
        <div
          style={{
