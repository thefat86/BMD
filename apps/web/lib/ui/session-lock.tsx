  ...
  return (
    <div
      ...
      style={{
        ...
        inset: 0,
        background: isMobile
          ? "radial-gradient(800px 500px at 50% -10%, rgba(197,138,46,0.18), transparent 60%), linear-gradient(180deg, #FBF6EC 0%, #F4ECD8 100%)"
          : "rgba(43,31,21,0.55)",
    ...
    >
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: 24,
              background:
                "linear-gradient(135deg, rgba(197,138,46,0.20), rgba(159,70,40,0.10))",
              border: "1.5px solid rgba(197,138,46,0.35)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              boxShadow: "0 12px 40px rgba(197,138,46,0.20)",
            }}
          >
            {/* V181 — Écran de verrouillage : decoding async (lazy non pertinent — visible immédiatement quand affiché). */}
      ...
      <div
        style={{
          ...
          color: "#2B1F15",
          textAlign: "center",
          boxShadow: "0 30px 80px rgba(43,31,21,0.18)",
        }}
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "linear-gradient(135deg, rgba(197,138,46,0.18), rgba(159,70,40,0.10))",
        ...
        >
          <Icon name="lock" size={32} color="#C58A2E" strokeWidth={1.8} />
        </div>
