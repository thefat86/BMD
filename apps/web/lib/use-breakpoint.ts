...
export function useBreakpoint(): BreakpointState {
  // V177 — IMPORTANT : le 1er render DOIT renvoyer la même valeur côté SSR et
  // côté client pour éviter les erreurs d'hydration React 19. Donc on
  // initialise toujours en `ready: false` (état neutre), puis on bascule
  // dans le useEffect post-mount. Coût : un flash de 1-2 frames du
  // placeholder ivory avant que le shell réel apparaisse. Bénéfice : zéro
